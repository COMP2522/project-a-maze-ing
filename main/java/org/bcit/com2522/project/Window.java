...
//  ArrayList<Menu> menus = new ArrayList<Menu>();
  ...
  /**
   * Getter for backgroundMainMenu
   * @return backgroundMainMenu
   */
  public PImage getBackgroundMainMenu() {
    return backgroundMainMenu;
  }

  /**
   * Setter for backgroundMainMenu
   * @param backgroundMainMenu
   */
  public void setBackgroundMainMenu(PImage backgroundMainMenu) {
  ...
  /**
   * Getter for playerAnimationTime
   * @return playerAnimationTime
   */
  public float getPlayerAnimationTime() {
    return playerAnimationTime;
  }

  /**
   * Setter for playerAnimationTime
   * @param playerAnimationTime
   */
  public void setPlayerAnimationTime(float playerAnimationTime) {
    this.playerAnimationTime = playerAnimationTime;
  }
   ...
   * @param elpCount
   */
  public void setElpCount(float elpCount) {
    this.elpCount = elpCount;
  }

  /**
   * Getter for loadingTimer
   * @return loadingTimer
   */
